...
export const t = {
  en: {
    nav: { lab: 'Lab', observe: 'Observe', play: 'Play', tools: 'Tools', manifesto: 'Manifesto', about: 'About' },
  ...
  ja: {
    nav: { lab: 'Lab', observe: 'Observe', play: 'Play', tools: 'Tools', manifesto: '存在理由', about: 'About' },
